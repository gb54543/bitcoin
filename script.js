...
.win-area {
  grid-column: span 2;
  background:
    radial-gradient(circle at top, rgba(0, 255, 220, 0.08), transparent 35%),
    linear-gradient(180deg, #0a1220 0%, #07101b 100%);
  border: 1px solid rgba(0, 255, 220, 0.15);
  box-shadow:
    0 0 20px rgba(0, 255, 220, 0.08),
    inset 0 0 18px rgba(0, 255, 220, 0.03);
}
...
.win-title {
  ...
  letter-spacing: 2px;
  color: #cffff8;
  text-shadow: 0 0 12px rgba(0,255,220,0.25);
}
...
.win-signal-btn {
  width: 100%;
  border: 1px solid #22f5d5;
  background: rgba(34,245,213,0.08);
  color: #8dfff2;
  border-radius: 14px;
  padding: 14px 12px;
  font-size: 16px;
  ...
  text-transform: uppercase;
  box-shadow:
    0 0 12px rgba(34,245,213,0.18),
    inset 0 0 10px rgba(34,245,213,0.06);
}
...
.win-box {
  background: rgba(34,245,213,0.05);
  border: 1px solid rgba(34,245,213,0.3);
  border-radius: 12px;
  padding: 12px;
  text-align: center;
  box-shadow:
    0 0 10px rgba(34,245,213,0.12),
    inset 0 0 8px rgba(34,245,213,0.04);
}
...
.win-prob-box strong {
  font-size: 28px;
  color: white;
  text-shadow: 0 0 12px rgba(34,245,213,0.2);
}
